...
from SpriteSomethingPy import layoutlib
...
class SpriteParent():
	...
	def load_plugins(self):
		try:
			...
			plugins_module = importlib.import_module(f"SpriteSomethingPy.{plugins_dir}.{self.classic_name.lower()}.plugins")
	...
	def import_from_filename(self):
		...
		if file_extension.lower() == '.png':
			...
			rom_module = importlib.import_module(f"SpriteSomethingPy.{rom_dir}.rom")
